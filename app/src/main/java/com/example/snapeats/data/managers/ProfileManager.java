...
import com.example.snapeats.ui.profile.EditProfileFragment;
import com.example.snapeats.ui.profile.OrderHistory;
import com.example.snapeats.ui.profile.PaymentProfile;
import com.example.snapeats.ui.profile.ProfileAddressFragment;
...
public class ProfileManager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) { // first launch
            ...
            }else if ("order_history".equals(screen)) {
                fragmentToLoad = new OrderHistory();
            } else {
